            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="sidebar-sticky pt-3">
                    ...
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link" href="dashboard.html" id="dashboardLink">
                                Dashboard
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="category.html" id="categoryLink">
                                Category
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="product.html" id="productLink">
                                Products
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="user.html" id="userLink">
                                Users
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="order.html" id="orderLink">
                                Orders
                            </a>
                        </li>
